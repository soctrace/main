...
CREATE INDEX IF NOT EXISTS idx_agent_turns_conversation_created
    ON core.agent_turns(conversation_id, created_at);

CREATE INDEX IF NOT EXISTS idx_agent_turns_metric
    ON core.agent_turns(metric);

CREATE INDEX IF NOT EXISTS idx_agent_turns_tool_name
    ON core.agent_turns(tool_name);

CREATE INDEX IF NOT EXISTS idx_agent_turns_sections_gin
    ON core.agent_turns USING GIN (sections);

CREATE INDEX IF NOT EXISTS idx_agent_turns_result_rows_gin
    ON core.agent_turns USING GIN (result_rows);
